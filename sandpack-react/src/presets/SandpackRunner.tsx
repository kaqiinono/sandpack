...
import type { SandpackPredefinedTemplate, SandpackSetup, SandpackThemeProp } from '../types';
...
export const SandpackRunner: React.FC<SandpackRunnerProps> = ({
    ...
    const mainFile = customSetup?.main ?? SANDBOX_TEMPLATES[template || 'vanilla'].main;
