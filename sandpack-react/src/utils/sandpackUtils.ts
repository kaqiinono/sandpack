import type { SandpackBundlerFile, SandpackBundlerFiles } from '../../../sandpack-client';
...
export const getSandpackStateFromProps = (props: SandpackProviderProps): SandpackContextInfo => {
...
const createSetupFromUserInput = (setup?: SandpackSetup): Partial<SandboxTemplate> | null => {
    if (!setup) {
        return null;
    }
    ...
    const convertedFiles = Object.keys(files).reduce((acc: SandpackBundlerFiles, key) => {
